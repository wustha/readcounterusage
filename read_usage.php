...
?>
    ...
    <fieldset>
    <div class="per_title">
      <h2><?php echo __('Statistik Eksemplar Dibaca'); ?></h2>
    </div>
    <div class="infoBox">
...
<?php
    ...
    function showUsage($obj_db, $array_data, $int_current_field_num)
    {
        ...
        $_usage_q = $obj_db->query('SELECT COUNT(*) FROM read_counter AS l
            WHERE l.item_code=\''.$array_data[0].'\' AND l.created_at LIKE \''.$selected_year.'-'.$array_data[$int_current_field_num].'%\'');
    ...
    echo $reportgrid->createDataGrid($dbs, $table_spec, 500);
